...
namespace Medical.Common.Helpers
{
    ...
    {
        public static string PasswordHash(string plainText, string hashAlgorithm, byte[] saltBytes)
        {
        ...
        public static bool VerifyPasswordHash(string plainText, string hashAlgorithm, string hashValue)
        {
            ...
            expectedHashString = PasswordHash(plainText, hashAlgorithm, saltBytes);
